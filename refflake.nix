  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      systemSettings = {
        ...
        hostname = "riley-pc"; # hostname
        profile = "personal"; # select a profile defined from my profiles directory
        timezone = "Sydney/Australia"; # select timezone
      ...
      userSettings = rec {
        ...
        name = "Riley"; # name/identifier
        email = "riley.d.sutton@gmail.com"; # email (used for certain configurations)
