{ config, lib, pkgs, userSettings, systemSettings, ... }: 
  let
    ...
    keymapConf = (import ./conf.nix) { inherit userSettings systemSettings themeNamed desktopEnvConfig; };
    themeConf = (import ./conf.nix) { inherit userSettings systemSettings themeNamed desktopEnvConfig; };
  in {
    config = {
