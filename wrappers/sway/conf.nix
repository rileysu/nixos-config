...
client.focused_inactive #${theme.brightBlue} #${theme.background} #${theme.foreground} #${theme.brightBlue} #${theme.brightBlue}
client.unfocused        #${theme.blue} #${theme.background} #${theme.foreground} #${theme.blue} #${theme.blue}
...
bar {
    ...
    colors {
        ...
        focused_workspace   #${theme.blue} #${theme.blue} #${theme.background}
        active_workspace    #${theme.black} #${theme.background} #${theme.blue}
        inactive_workspace  #${theme.black} #${theme.background} #${theme.blue}
        urgent_workspace    #${theme.brightRed} #${theme.brightRed} #${theme.yellow}
        binding_mode        #${theme.brightRed} #${theme.brightRed} #${theme.yellow}
    }
}
